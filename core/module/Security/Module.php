...
use Security\Service\ClientService;
use Security\Service\TokenService;
    ...
    public function getServiceConfig()
    {
        return array(
            ...
            'factories' => array(
                ...
                'token_service' => function($sm){
                    $om = $sm->get('Doctrine\ORM\EntityManager');
                    return new TokenService($om);
                },                
                'client_service' => function($sm){
                    $om = $sm->get('Doctrine\ORM\EntityManager');
                    return new ClientService($om);
                }                
