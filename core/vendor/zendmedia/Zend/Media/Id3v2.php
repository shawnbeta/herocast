...
/**#@+ @ignore */
require_once 'vendor/zendmedia/Zend/Media/Id3/Object.php';
require_once 'vendor/zendmedia/Zend/Media/Id3/Header.php';
...
final class Zend_Media_Id3v2 extends Zend_Media_Id3_Object
{
    ...
    public function __construct($filename = null, $options = array())
    {
        ...
        if ($filename instanceof Zend_Io_Reader) {
            ...
            require_once 'vendor/zendmedia/Zend/Io/FileReader.php';
            try {
                $this->_reader = new Zend_Io_FileReader($filename);
            } catch (Zend_Io_Exception $e) {
                $this->_reader = null;
                require_once 'vendor/zendmedia/Zend/Media/Id3/Exception.php';
        ...
        if ($this->_header->getVersion() < 4 &&
            ...
            require_once 'vendor/zendmedia/Zend/Io/StringReader.php';
        ...
        if ($this->_header->hasFlag(Zend_Media_Id3_Header::EXTENDED_HEADER)) {
            require_once 'vendor/zendmedia/Zend/Media/Id3/ExtendedHeader.php';
        ...
        while (true) {
            ...
            if (@fopen($file = 'vendor/zendmedia/Zend/Media/Id3/Frame/' .
            ...
            if (class_exists
                ...
                require_once 'vendor/zendmedia/Zend/Media/Id3/Frame/Unknown.php';
                $frame =
    ...
    public function write($filename)
    {
        if ($filename === null && ($filename = $this->_filename) === null) {
            ...
            require_once 'vendor/zendmedia/Zend/Io/Writer.php';
    ...
    public function __get($name)
    {
        ...
        if (@fopen($filename = 'vendor/zendmedia/Zend/Media/Id3/Frame/' . ucfirst($name) .
                   '.php', 'r', true) !== false) {
