...
{
    /**
     * Peforms a few basic test of your PHP installation's SSL implementation to see
     * if it insecure in an obvious way.  Results are written with "echo" and the output
     * is HTML-safe.
     *
     * @return bool
     *    Returns <code>true</code> if all the test passed.
     */
